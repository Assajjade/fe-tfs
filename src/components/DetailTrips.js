        ...
        <Card sx={{ backgroundColor: '#f0f0f0' }}>
          ...
          <Box sx={{ padding: 4 }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <div style={{ display: 'flex' }}>
                  <div style={{ width: '150px', fontWeight: 'bold' }}>Preparation</div>
                  <div>: {trip.preparation}</div>
                </div>
                <div style={{ display: 'flex' }}>
                  <div style={{ width: '150px', fontWeight: 'bold' }}>Capacity</div>
                  <div>: {trip.capacity}</div>
                </div>
                <div style={{ display: 'flex' }}>
                  <div style={{ width: '150px', fontWeight: 'bold' }}>Skills</div>
                  <div>: {trip.skills}</div>
                </div>
                <div style={{ display: 'flex' }}>
                  <div style={{ width: '150px', fontWeight: 'bold' }}>vroles</div>
                  <div>: {trip.vroles}</div>
                </div>
                <div style={{ display: 'flex' }}>
                  <div style={{ width: '150px', fontWeight: 'bold' }}>Captain</div>
                  <div>: {trip.captain}</div>
                </div>
              </Grid>
            </Grid>
          </Box>
