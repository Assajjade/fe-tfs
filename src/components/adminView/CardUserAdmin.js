...
const CardUserAdmin = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
      <Card style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)', width: '200px', height: '100px', marginRight: '20px', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)' }}>
        <CardContent>
          <Typography variant="h6" component="div" sx={{ fontFamily: 'Nunito, sans-serif', color: '#333' }}>
            Users
          </Typography>
